...
public class Parameters {
  ...
  //Hive:
  public static final Param<String> HIVE_METASTORE_HOST = Param.string("hive.metastore.host", "namenode1");
  public static final Param<Integer> HIVE_METASTORE_PORT = Param.integer("hive.metastore.port", 9083);
